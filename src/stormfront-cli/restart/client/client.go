...
var ClientHelpText = fmt.Sprintf(`usage: stormfront restart client [-H|--host <stormfront host>] [-p|--port <stormfront port>] [-l|--log-level <log level>] [-h|--help]
arguments:
...
func ExecuteClient(host, port string) error {
	logging.Info("Restarting stormfront client...")
