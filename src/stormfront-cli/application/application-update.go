...
var ApplicationUpdateHelpText = fmt.Sprintf(`usage: stormfront application update [-d|--definition <application definition file path>] [-H|--host <stormfront host>] [-p|--port <stormfront port>] [-l|--log-level <log level>] [-h|--help]
arguments:
