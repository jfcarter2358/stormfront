...
var ClientGetAPITokenHelpText = fmt.Sprintf(`usage: stormfront client get-api-token [-H|--host <stormfront host>] [-p|--port <stormfront port>] [-l|--log-level <log level>] [-h|--help]
arguments:
...
func ParseGetAPITokenArgs(args []string) (string, string, error) {
	host := "localhost"
	port := "6626"
...
func ExecuteGetAPIToken(host, port string) error {
