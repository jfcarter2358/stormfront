...
var ApplicationCreateHelpText = fmt.Sprintf(`usage: stormfront deploy application -d|--definition <application definition file path> [-H|--host <stormfront host>] [-p|--port <stormfront port>] [-l|--log-level <log level>] [-h|--help]
arguments:
...
func ExecuteApplication(host, port, definition string) error {
